...
@endpush
@section('content')
    @include('backend.layout.inc.breadcump', ['page_name' => 'Hotel Create'])
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                        ...
                        <form action="{{ route('hotel.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    <label for="hotel_location">Hotel Location<span
                                            class="text-danger">*</span></label>
                                    <input type="text" min="1" id="hotel_location" name="hotel_location"
                                        value="{{ old('hotel_location') }}" placeholder="Enter hotel location"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" id="room_price" name="room_price"
                                        value="{{ old('room_price') }}" placeholder="Enter hotel price"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="number" max="5" placeholder="Enter hotel rating" min="0"
                                        id="hotel_rating" name="hotel_rating" value="{{ old('hotel_rating') }}"
                                ...
                                is-invalid
                                @enderror"
                                        placeholder="Enter package details">{{ old('hotel_details') }}</textarea>
                                    @error('hotel_details')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
