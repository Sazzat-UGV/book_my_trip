...
@endpush
@section('content')
    @include('backend.layout.inc.breadcump', ['page_name' => 'Package Edit'])
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="number" min="1" id="package_period" name="package_period"
                                        value="{{ $package->package_period }}" placeholder="Enter package period"
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" id="package_price" name="package_price"
                                        value="{{ $package->package_price }}" placeholder="Enter package price"
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="number" max="5" placeholder="Enter package rating" min="0"
                                        id="package_rating" name="package_rating" value="{{ $package->package_rating }}"
                                ...
                                is-invalid
                                @enderror"
                                        placeholder="Enter package details">{{ $package->package_details }}</textarea>
                                ...
                                <div class="col-12 mb-3">
                                    <label>Package Image (780*420)</label>
                                    <input type="file" name="package_image" data-default-file="{{ asset('uploads/package') }}/{{ $package->package_image }}"
                                ...
                                <div class="col-12 mb-3">
                                    <label for="package_multiple_image">
                                        Package Multiple Image (200*200)
                                    </label>
