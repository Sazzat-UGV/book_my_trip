                        ...
                        <form action="{{ route('flight.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" name="airlines_name" value="{{ old('airlines_name') }}"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text"  id="airlines_model" name="airlines_model"
                                        value="{{ old('airlines_model') }}" placeholder="Enter airlines model"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="number" min="1" id="total_sit" name="total_sit" value="{{ old('total_sit') }}"
