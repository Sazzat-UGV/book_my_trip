            ...
            <div class="col-sm-12">
                <div class="top">
                    <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="social-buttons">
                                                <a href="{{ route('loginprovider',['provider'=>'google']) }}" class="btn btn-tw"><i
                                                    class="fa-brands fa-google"></i>
                                                Google</a>
                                            <a href="{{ route('loginprovider',['provider'=>'facebook']) }}" class="btn btn-fb"><i
                        ...
                        @auth
                        <li class="border_1"><a class="text_1" href="{{ route('logout') }}"><i class="fa fa-phone"></i>
                            Logout </a>
                    </li>
                        @endauth
                    </ul>
